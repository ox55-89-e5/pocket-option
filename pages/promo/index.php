  ...
  <div class="container">
    ...
    <div class="promo-cards">
      ...
      <div class="card card-2 promo-card">
        ...
        <a href="https://pocoptrade.com/register" class="btn btn-primary" target="_blank" rel="noopener noreferrer">Активировать</a>
      </div>
      <?php endforeach; ?>
    </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="https://pocoptrade.com/register" class="btn btn-primary btn-sm" target="_blank" rel="noopener noreferrer">Активировать</a></td>
          </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
  ...
  <div class="container">
    ...
    <div class="grid-2">
      <div class="card">
        ...
        <a href="https://pocoptrade.com/register" class="btn btn-primary" target="_blank" rel="noopener noreferrer">Использовать START100</a>
      </div>
      <div class="card">
        <div class="icon-box">💎</div>
        ...
        <div class="bonus-details"><span>Вейджер: x3</span><span>Срок: 30 дней</span></div>
        <a href="https://pocoptrade.com/register" class="btn btn-primary" target="_blank" rel="noopener noreferrer">Использовать WELCOME50</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="cashback-grid">
      <div class="cashback-text">
        ...
        <a href="https://pocoptrade.com/register" class="btn btn-primary" target="_blank" rel="noopener noreferrer">Активировать CASHBACK20</a>
      </div>
